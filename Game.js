     ...
     */
     endGame () {
        ...
        if (this.player.lives != 0){
            let Win = new Entity(this, this.width / 2, "auto", this.width / 4, this.height / 4, 0, YOU_WIN_IMAGE)
            Win.render();
            this.ended = true;
        } else {
            this.ended = true;
            var gameOver = new Entity(this, this.width / 2, "auto", this.width / 4, this.height / 4, 0, GAME_OVER_PICTURE)
            gameOver.render();}
